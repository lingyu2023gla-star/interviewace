...
- 当前已具备 `chunk_embeddings` 存储结构、本地 `EmbeddingRetriever` 和 RRF `HybridRetriever`，但尚未接真实 embedding API，preparation 主链路也尚未切换到 embedding / hybrid 检索。
- 当前没有实现模型微调。
