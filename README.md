...
- V10 Skill Layer 已新增 Skill Spec / Registry、`InterviewPreparationSkill`、`ProjectPitchSkill`、Skill API / Async Task、Skill Evaluation 和 Rule-based Skill Router，详见 [docs/skills.md](docs/skills.md)、[docs/interview_preparation_skill.md](docs/interview_preparation_skill.md)、[docs/project_pitch_skill.md](docs/project_pitch_skill.md)、[docs/skill_api.md](docs/skill_api.md)、[docs/skill_evaluation.md](docs/skill_evaluation.md) 与 [docs/skill_router.md](docs/skill_router.md)。
- V10 Release / Demo Pack 提供稳定版本说明、架构说明和 Skill API demo，详见 [docs/v10_release_notes.md](docs/v10_release_notes.md)、[docs/v10_architecture.md](docs/v10_architecture.md) 与 [docs/skill_api_demo.md](docs/skill_api_demo.md)。
...
- 当前已具备 `chunk_embeddings` 存储结构、本地 `EmbeddingRetriever` 和 RRF `HybridRetriever`，但尚未接真实 embedding API；preparation 可通过 `retriever_type` 显式选择 embedding / hybrid，默认仍是 keyword。
- 当前没有实现模型微调。
